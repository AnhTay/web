...
if (!(file_exists('TUANORI_SYSTEM/ketnoi@data.php'))) {   
...
if($token) $btn_logout = "Đăng Xuất"; else $btn_logout = "Đăng ký";
if($token) $href_login = '/user/profile'; else $href_login = "dang-nhap";
if($token) $href_logout = "/user/dang-xuat"; else $href_logout = "/dang-ki";
if($kun->is_admin()) $btn_admin = '<li class=" "><a  href="/admin" ><b>ADMIN CP</b></a></li>'; else $btn_admin = '';
if($kun->is_congtacvien()) $btn_ctv = '<li class=" "><a  href="/congtacvien" ><b>CTV</b></a></li>'; else $btn_ctv = '';
